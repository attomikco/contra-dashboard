...
export const mockTickets: Ticket[] = [
  { id: 't_1',  event_id: 'e_1', member_id: 'm_1',  member_name: 'Maya Rodriguez',  member_initials: 'MR', tier: 'premium',  tier_ticket: 'premium',       status: 'confirmed',  qr_code: 'CNTR-MR-0001', purchased_at: '2026-04-02T10:00:00Z', plus_one: false },
  { id: 't_2',  event_id: 'e_1', member_id: 'm_2',  member_name: 'João Teixeira',   member_initials: 'JT', tier: 'founding', tier_ticket: 'founding_comp', status: 'checked_in', qr_code: 'CNTR-JT-0002', purchased_at: '2026-04-02T10:15:00Z', checked_in_at: '2026-04-22T17:55:00Z', plus_one: false },
  { id: 't_3',  event_id: 'e_1', member_id: 'm_3',  member_name: 'Aisha Khan',      member_initials: 'AK', tier: 'premium',  tier_ticket: 'premium',       status: 'confirmed',  qr_code: 'CNTR-AK-0003', purchased_at: '2026-04-04T14:20:00Z', plus_one: true },
  { id: 't_4',  event_id: 'e_1', member_id: 'm_4',  member_name: 'Liam Sørensen',   member_initials: 'LS', tier: 'standard', tier_ticket: 'general',       status: 'confirmed',  qr_code: 'CNTR-LS-0004', purchased_at: '2026-04-05T11:00:00Z', plus_one: false },
  { id: 't_5',  event_id: 'e_1', member_id: 'm_5',  member_name: 'Priya Venkatesh', member_initials: 'PV', tier: 'standard', tier_ticket: 'general',       status: 'checked_in', qr_code: 'CNTR-PV-0005', purchased_at: '2026-04-14T20:00:00Z', checked_in_at: '2026-04-22T18:10:00Z', plus_one: false },
  { id: 't_6',  event_id: 'e_1', member_id: 'm_6',  member_name: 'Sofia Marques',   member_initials: 'SM', tier: 'premium',  tier_ticket: 'premium',       status: 'confirmed',  qr_code: 'CNTR-SM-0006', purchased_at: '2026-04-03T16:40:00Z', plus_one: true },
  { id: 't_7',  event_id: 'e_1', member_id: 'm_8',  member_name: 'Camila Santos',   member_initials: 'CS', tier: 'founding', tier_ticket: 'founding_comp', status: 'checked_in', qr_code: 'CNTR-CS-0007', purchased_at: '2026-04-01T09:00:00Z', checked_in_at: '2026-04-22T18:02:00Z', plus_one: false },
  { id: 't_8',  event_id: 'e_1', member_id: 'm_9',  member_name: 'Tomás Ferreira',  member_initials: 'TF', tier: 'standard', tier_ticket: 'general',       status: 'cancelled',  qr_code: 'CNTR-TF-0008', purchased_at: '2026-04-06T13:00:00Z', plus_one: false },
  { id: 't_9',  event_id: 'e_1', member_id: 'm_11', member_name: 'Henrique Dias',   member_initials: 'HD', tier: 'premium',  tier_ticket: 'premium',       status: 'confirmed',  qr_code: 'CNTR-HD-0009', purchased_at: '2026-04-07T19:30:00Z', plus_one: false },
  { id: 't_10', event_id: 'e_1', member_id: 'm_12', member_name: 'Nadia Oliveira',  member_initials: 'NO', tier: 'founding', tier_ticket: 'founding_comp', status: 'checked_in', qr_code: 'CNTR-NO-0010', purchased_at: '2026-04-01T09:00:00Z', checked_in_at: '2026-04-22T17:45:00Z', plus_one: false },
];
...
export const mockContent: ContentAsset[] = [
  ...
  { id: 'c_8', event_id: 'e_1', event_title: 'AI x design meetup',        kind: 'social_post',   title: 'Pre-event teaser — reel',                                                               scheduled_for: '2026-04-20T09:00:00Z', status: 'scheduled', views: 0, shares: 0, cover_color: 'green', author: 'Nadia Oliveira' },
  { id: 'c_9', event_id: 'e_1', event_title: 'AI x design meetup',        kind: 'press_clip',    title: 'Observador preview piece — draft',                                                                                                                          status: 'draft',     views: 0, shares: 0, cover_color: 'cream', author: 'Observador — Culture' },
];
...
export const mockThreads: Thread[] = [
  { id: 'th_1', event_id: 'e_1', event_title: 'AI x design meetup',    starter_name: 'Maya Rodriguez',  starter_initials: 'MR', starter_variant: 'green', subject: 'Can anyone share their AI design ops workflow?', snippet: "I've been experimenting with Claude + Figma plugins and I'd love to compare notes...",          reply_count: 8,  unanswered: false, last_message_at: '2026-04-17T06:30:00Z' },
  { id: 'th_2', event_id: 'e_1', event_title: 'AI x design meetup',    starter_name: 'Priya Venkatesh', starter_initials: 'PV', starter_variant: 'dark',  subject: 'Will the talks be recorded?',                     snippet: "First-timer — wondering if the sessions will be available after.",                                reply_count: 0,  unanswered: true,  last_message_at: '2026-04-16T21:15:00Z' },
